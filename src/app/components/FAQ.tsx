    ...
    <section className="py-20 bg-card">
      <div className="max-w-3xl mx-auto px-6">
        ...
        <div className="flex flex-col gap-3">
          {FAQS.map((faq, i) => (
            <div
              ...
              style={{ borderColor: open === i ? "var(--primary)" : "var(--border)" }}
            >
              <button
              ...
              >
                <span
                  ...
                  style={{
                    ...
                    fontWeight: 600,
                    fontSize: "0.95rem",
                    color: open === i ? "var(--primary)" : "var(--foreground)",
                  }}
                >
                  {faq.q}
                </span>
                <div
                  ...
                  style={{ background: open === i ? "var(--primary)" : "var(--muted)" }}
                >
                  {open === i
        ...
        <div className="mt-10 text-center">
          <p className="text-muted-foreground text-sm mb-3" style={{ fontFamily: "'Inter', sans-serif" }}>
          ...
          <a
            ...
            className="inline-flex items-center gap-2 bg-primary text-primary-foreground px-6 py-3 rounded-full text-sm hover:bg-primary/85 transition-colors"
