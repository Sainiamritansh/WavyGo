        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-4">
          <div>
            ...
            <p className="text-gray-500 mt-2 max-w-xl" style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.95rem" }}>
              Travel guides, route journals, and riding stories from real people who've been there.
            </p>
          </div>
          <button
          ...
          <div className="lg:col-span-2 bg-white rounded-3xl overflow-hidden shadow-sm hover:shadow-lg transition-shadow group cursor-pointer">
            ...
            <div className="p-7">
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="text-gray-400 text-xs" style={{ fontFamily: "'Inter', sans-serif" }}>{featured.date}</span>
              </div>
              <h3
                className="text-[#111827] mb-3"
                style={{ fontFamily: "'Outfit', sans-serif", fontWeight: 800, fontSize: "1.35rem" }}
              >
                {featured.title}
              </h3>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-gray-800 text-xs" style={{ fontFamily: "'Inter', sans-serif", fontWeight: 600 }}>{featured.author}</p>
                ...
                <button
                  className="flex items-center gap-1.5 text-[#1a5c38] text-sm"
