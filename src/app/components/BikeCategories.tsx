      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex items-end justify-between mb-12">
          <div>
            ...
            <p className="text-gray-500 mt-2 max-w-lg" style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.95rem" }}>
            ...
            >
              ...
              <div className="absolute top-3 left-3 z-10">
                <span
                  ...
                  style={{ fontFamily: "'Inter', sans-serif", fontWeight: 600, fontSize: "0.68rem" }}
                >
                  {cat.tag}
                </span>
              </div>
              ...
              <div className="p-4">
                <div className="flex items-start justify-between">
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-gray-400 text-xs" style={{ fontFamily: "'Inter', sans-serif" }}>/day</p>
                  </div>
                </div>
                ...
                <button
                  ...
                  style={{
                    ...
                    fontWeight: 600,
                    background: hovered === cat.id ? "#1a5c38" : "rgba(26,92,56,0.08)",
